package com.coditos.splitmeet.features.manageOuting.presentation.viewmodels
            ...
            _uiState.update { state ->
                result.fold(
                    onSuccess = { createdOuting ->
                        Log.d("ManageOutingViewModel", "Outing created: $createdOuting")
                        state.copy(
                            isLoading = false,
                            isSuccess = true,
                    ...
                    onFailure = { error ->
                        Log.e("ManageOutingViewModel", "Error creating outing", error)
                        state.copy(
                            isLoading = false,
